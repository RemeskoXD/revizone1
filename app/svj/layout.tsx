...
export default async function SVJLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="flex min-h-dvh bg-black text-white">
      <MobileSidebarToggle>
        <div className="p-6">
          <Link href="/svj" className="flex flex-wrap items-center gap-2 text-lg font-bold tracking-tight text-white sm:text-xl">
            ...
            <span className="rounded-full bg-rose-500/10 px-2 py-0.5 text-xs font-normal text-rose-400">SVJ</span>
          </Link>
        </div>
        ...
        <div className="border-t border-white/5 p-4">
          ...
          <Link href="/svj/settings" className="flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-gray-400 transition-colors hover:bg-white/5 hover:text-white">
